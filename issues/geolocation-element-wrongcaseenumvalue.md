---
Title: Enum values that ignore naming conventions in The HTML Geolocation Element
Tracked: 'https://github.com/WICG/PEPC/issues/98'
Repo: 'https://github.com/WICG/PEPC'
---

While crawling [The HTML Geolocation Element](https://wicg.github.io/PEPC/geolocation-element.html), the following enum values were found to ignore naming conventions (lower case, hyphen separated words):
