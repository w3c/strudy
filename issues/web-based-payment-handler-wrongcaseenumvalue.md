---
Title: Enum values that ignore naming conventions in Web-based Payment Handler API
Tracked: N/A
Repo: 'https://github.com/w3c/web-based-payment-handler'
---

While crawling [Web-based Payment Handler API](https://w3c.github.io/web-based-payment-handler/), the following enum values were found to ignore naming conventions (lower case, hyphen separated words):
