...
* [ ] The [fire a push event](https://w3c.github.io/push-api/#dfn-fire-a-push-event) algorithm resolves/rejects a promise directly in a step that runs in parallel
